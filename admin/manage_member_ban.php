...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "ban")) {
  ...
  $updateGoTo = "manage_member_ban.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_connection, $connection);
$query_showmember = "SELECT * FROM tb_member WHERE AccessLevel = 'B' ORDER BY Member_id DESC";
...
<link href="../css/wat.css" rel="stylesheet" />
  ...
  <div class="container">
  	<div class="row">
    <h4 align="center">
    hi: <?php echo $row_mem['Fname']; ?>&nbsp;<a href="adminpage.php">กลับเมนูหลัก</a>&nbsp;<a href="manage_member.php">กลับหน้าจัดการสมาชิก</a>&nbsp; <a href="<?php echo $logoutAction ?>">ออกจากระบบ</a></h4>
     ...
     <div class="col-md-6"> </div>
    	...
    	<div class="col-md-12">
          ...
          <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="40" colspan="11" align="center" bgcolor="#EBEBEB"><h4> บริหารจัดการสมาชิกที่โดนแบน</h4>                
            ...
            <?php do { ?>
              <tr>
                ...
                <td align="center" valign="top"><b><font color="red"><?php echo $row_showmember['AccessLevel']; ?> </font></b></td>
                ...
                <td width="5%" align="center"><form action="<?php echo $editFormAction; ?>" method="POST" name="ban" id="ban">
                  ...
                  <input name="AccessLevel" type="hidden" id="AccessLevel" value="M">
                  <input type="submit" name="BAN" id="BAN" value="UnBAN" class="btn btn-danger btn-xs" onclick="return confirm('คุณต้องการยกเลิกการแบนหรือไม่ ')">
<br>
