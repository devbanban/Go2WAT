...
<div class="container">
  <div class="row">
    <h4 align="center"> hi: <?php echo $row_mem['Fname']; ?>&nbsp;<a href="adminpage.php">กลับเมนูหลัก</a>&nbsp;<a href="add_gallery.php">กลับหน้าแกลเลอรี่</a>&nbsp; <a href="<?php echo $logoutAction ?>">ออกจากระบบ</a><br>
    </h4>
    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" id="top">
      ...
      <?php do { ?>
        <tr>
          ...
          <td width="5%" align="left"> &nbsp;<img src="gallery/<?php echo $row_show_gall['Img_index']; ?>" width="120"></td>
    ...
    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php do { ?>
        <tr>
          ...
          <td> &nbsp;<img src="gallery/<?php echo $row_gall_img['Img']; ?>" width="100"></td>
