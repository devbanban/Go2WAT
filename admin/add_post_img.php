...
<div class="container">
  <div class="row">
    <h4 align="center"> hi: <?php echo $row_mem['Fname']; ?>&nbsp;<a href="adminpage.php">กลับเมนูหลัก</a>&nbsp;<a href="add_post.php">กลับหน้าเพิ่มกระทู้</a>&nbsp; <a href="<?php echo $logoutAction ?>">ออกจากระบบ</a><br>
    </h4>
    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" id="top">
      ...
      <?php do { ?>
        <tr>
          ...
          <td width="5%" align="left"> &nbsp;<img src="post/<?php echo $row_show_post['Img_index']; ?>" width="120"></td>
    ...
    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php do { ?>
        <tr>
          ...
          <td> &nbsp;<img src="post/<?php echo $row_post_img['img']; ?>" width="100"></td>
...
<br>
    ...
    <form action="add_post_img_db.php" method="POST" enctype="multipart/form-data" name="add_post_img" id="add_post_img">
      ...
      <table width="70%" border="0" align="center" cellpadding="3" cellspacing="3">
        ...
        <tr>
          <td height="40" colspan="3" align="center" bgcolor="#EEEEEE"><strong>เพิ่มภาพในแกลเลอรี่ ID : <?php echo $row_Post_id['Post_id']; ?></strong></td>
        </tr>
        <tr>
