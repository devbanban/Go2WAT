...
$(function() {
 ...
 <form method="POST" action="edit_news_db.php" enctype="multipart/form-data" name="edit_news" id="edit_news">
   ...
   <table width="80%" border="0" align="center" cellpadding="3" cellspacing="3">
     ...
     <tr>
       <td colspan="2" align="center" bgcolor="#f1f1f1"><img src="file_news/<?php echo $row_listnews['File_news']; ?>" width="100"><?php echo $row_listnews['File_news']; ?></td>
     </tr>
     <tr>
...
*/
     ...
     <tr>
       <td width="20%" align="right" bgcolor="#f1f1f1">&nbsp;</td>
       <td width="80%" bgcolor="#f1f1f1">&nbsp;</td>
     </tr>
     <tr>
       <td colspan="2" align="center" bgcolor="#f1f1f1">
       
       <input type="button" value="ยกเลิก" class="btn-default"  onclick="window.location='add_news.php' " />
       
         &nbsp;          &nbsp;  <input type="submit" name="button" id="button" value="update" class="btn-primary"></td>
     </tr>
     <tr>
       <td bgcolor="#f1f1f1">&nbsp;</td>
       <td bgcolor="#f1f1f1">&nbsp;</td>
