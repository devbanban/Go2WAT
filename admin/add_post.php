...
mysql_select_db($database_connection, $connection);
$query_show_post = "SELECT * FROM tb_post ORDER BY Post_id DESC";
...
<div class="container">
  <div class="row">
    ...
    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="40" colspan="9" align="center" bgcolor="#D6D5D6">
        <h4>จัดการกระทู้</h4>&nbsp;&nbsp; <strong><a href="#add_post">+ กระทู้ </a>  <br>
แสดงรายการที่ <?php echo ($startRow_show_post + 1) ?>&nbsp; ถึง&nbsp;<?php echo min($startRow_show_post + $maxRows_show_post, $totalRows_show_post) ?>&nbsp;รวมทั้งหมด&nbsp;<?php echo $totalRows_show_post ?> &nbsp;รายการ <br>
      ...
      <tr>
        ...
        <td width="28%" align="center" bgcolor="#D6D5D6"><strong>Title</strong></td>
        <td width="13%" align="center" bgcolor="#D6D5D6"><strong>Addby</strong></td>
        <td width="15%" align="center" bgcolor="#D6D5D6"><strong>DateAdd</strong></td>
        <td width="13%" align="center" bgcolor="#D6D5D6"><strong>status</strong></td>
        <td colspan="4" align="center" bgcolor="#D6D5D6"><strong>Manage</strong></td>
      </tr>
      <?php do { ?>
        <tr>
          <td><img src="post/<?php echo $row_show_post['Img_index']; ?>" width="100"></td>
          ...
          <td align="center" valign="top"><?php echo $row_show_post['Addby']; ?></td>
          <td align="left" valign="top"><?php echo $row_show_post['DateAdd']; ?></td>
          ...
          <td width="6%" align="center" valign="top"><form action="<?php echo $editFormAction; ?>" method="POST" name="show" id="show">
            ...
            <input name="Post_id" type="hidden" id="Post_id" value="<?php echo $row_show_post['Post_id']; ?>">
            <br>
            <br>
            <br>
         ...
         <input type="hidden" name="MM_update" value="hide">
          ...
          <br>
              <strong><a href="del_post.php?Post_id=<?php echo $row_show_post['Post_id']; ?>" 
                onclick="return confirm('คุณต้องการลบข้อมูลนี้หรือไม่ (ID: <?php echo $row_show_post['Post_id']; ?>) ')">&nbsp;<span class="glyphicon glyphicon-trash"></span></a></strong>
