    ...
    <div class="col-md-12">
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="register" onsubmit="passvalidate()" id="register">
        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="4" align="center"><input name="Member_id" type="hidden" id="Member_id" value="<?php echo $row_edit_member['Member_id']; ?>"> <input name="AccessLevel" type="hidden" id="AccessLevel" value="A"></td>
          </tr>
          <tr>
