  ...
  <div class="container">
    <div class="row"> 
     ...
     <div class="row wow fadeInUp">
                        ...
                        <p align="right">  
                        <form action="show_search_post.php#allpost" method="get" style="text-align:right">
                        <input type="text" name="Title" size="40"> &nbsp;<button type="submit" name="ok" value="fid" class="btn btn-info btn-xs"> ค้นหา </button>
