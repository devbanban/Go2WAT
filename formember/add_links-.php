...
$colname_showlinks = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_showlinks = $_SESSION['MM_Username'];
}
mysql_select_db($database_connection, $connection);
$query_showlinks = sprintf("SELECT * FROM tb_links WHERE Addby = %s ORDER BY id_links DESC", GetSQLValueString($colname_showlinks, "text"));
...
$(function() {
	$(document).on('change', '#img', function() {
		if(this.files[0].size > 204800) {
			alert('ไฟล์ภาพมีขนาดใหญ่เกินกำหนด (200 KB) กรุณา Resize รูปภาพก่อนทำการ Upload');
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="5%" height="40" align="center" bgcolor="#B8B8B8"><strong>id_links</strong></td>
          <td width="20%" height="40" align="center" bgcolor="#B8B8B8"><strong>Wat_name</strong></td>
          <td width="50%" height="40" align="center" bgcolor="#B8B8B8"><strong>Website</strong></td>
          <td width="20%" height="40" align="center" bgcolor="#B8B8B8"><strong>DateAdd</strong></td>
        </tr>
        <?php do { ?>
          <tr>
            <td align="center" bgcolor="#F0F0F0"><?php echo $row_showlinks['id_links']; ?></td>
            <td bgcolor="#F0F0F0"><?php echo $row_showlinks['Wat_name']; ?></td>
            <td height="30" bgcolor="#F0F0F0"><?php echo $row_showlinks['Website']; ?></td>
            <td bgcolor="#F0F0F0"><?php echo $row_showlinks['DateAdd']; ?></td>
          </tr>
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="add_links" onsubmit="passvalidate()" id="add_links">
        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="3"><input name="Wat_name" type="text"  required id="Wat_name" size="50"></td>
          </tr>
          <tr>
            <td align="right">เว็บไซต์&nbsp;</td>
            <td colspan="3"><input name="Website" type="password"   required id="Website" size="60"></td>
          </tr>
          <tr>
