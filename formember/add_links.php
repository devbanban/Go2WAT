...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h4 align="center">hi :&nbsp; <?php echo $row_member['Fname']; ?>&nbsp;<a href="index.php">กลับเมนูหลัก</a>&nbsp; <a href="<?php echo $logoutAction ?>">Log out</a>&nbsp; &nbsp;<br>
      </h4>
      <br>
      <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="40" colspan="9" align="center" bgcolor="#B8B8B8"><h4><a href="#form1">+ ADD LINKS</a>&nbsp;</h4>
  ...
  <tr>
    ...
    <td><?php if ($pageNum_showlinks < $totalPages_showlinks) { // Show if not last page ?>
        ...
        <tr>
          ...
          <td colspan="3" align="center" bgcolor="#B8B8B8"><strong>จัดการ</strong></td>
        </tr>
        <?php do { ?>
          <tr>
            ...
            <td align="center" bgcolor="#F0F0F0">
            <a href="edit_links.php?id_links=<?php echo $row_showlinks['id_links']; ?>">&nbsp;<span class="glyphicon glyphicon-pencil"></span></a></td>
          </tr>
