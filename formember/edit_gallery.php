...
if (isset($_GET['id_gall'])) {
  $colname_edit_gall = $_GET['id_gall'];
}
mysql_select_db($database_connection, $connection);
$query_edit_gall = sprintf("SELECT * FROM tb_gallery WHERE id_gall = %s", GetSQLValueString($colname_edit_gall, "int"));
$edit_gall = mysql_query($query_edit_gall, $connection) or die(mysql_error());
$row_edit_gall = mysql_fetch_assoc($edit_gall);
$totalRows_edit_gall = mysql_num_rows($edit_gall);
...
$(function() {
  ...
  <br>
 <form method="POST" action="edit_gall_db.php" enctype="multipart/form-data" name="edit_gall" id="edit_gall">
   <p>&nbsp;</p>
   <table width="70%" border="0" align="center" cellpadding="3" cellspacing="3">
     ...
     <tr>
       ...
       <td bgcolor="#f1f1f1"><?php echo $row_edit_gall['id_gall']; ?></td>
     </tr>
     <tr>
       <td width="20%" align="right" bgcolor="#f1f1f1">Title</td>
       <td width="80%" bgcolor="#f1f1f1">&nbsp;
         <label for="Title"></label>
         <input name="Title" type="text" required id="Title" placeholder="ชื่ออัลบั้ม *ไม่เกิน 150 ตัวอักษร " value="<?php echo $row_edit_gall['Title']; ?>" size="70" maxlength="150"></td>
     </tr>
     <tr>
     ...
     <tr>
       ...
       <td width="80%" bgcolor="#f1f1f1">&nbsp;
         ...
         <textarea name="Detail" cols="70" rows="10" required id="Detail" placeholder="คำอธิบาย"><?php echo $row_edit_gall['Detail']; ?></textarea></td>
     </tr>
     <tr>
       <td align="right" bgcolor="#f1f1f1">&nbsp;</td>
       <td bgcolor="#f1f1f1">&nbsp;</td>
     ...
     <tr>
       ...
       <td width="80%" bgcolor="#f1f1f1">&nbsp;
         ...
         <input name="Location" type="text" required id="Location" placeholder="ชื่อวัด *ไม่เกิน 150 ตัวอักษร " value="<?php echo $row_edit_gall['Location']; ?>" size="40" maxlength="150"></td>
     </tr>
     <tr>
       <td align="right" bgcolor="#f1f1f1">&nbsp;</td>
       <td bgcolor="#f1f1f1"><input name="status" type="hidden" id="status" value="Y"> <input name="id_gall" type="hidden" id="id_gall" value="<?php echo $row_edit_gall['id_gall']; ?>"></td>
     </tr>
     <tr>
       <td align="right" bgcolor="#f1f1f1">Img Index</td>
       <td bgcolor="#f1f1f1">&nbsp;
         <label>
           <input name="Img_index" type="file" required id="Img_index" value="<?php echo $row_edit_gall['Img_index']; ?>">
