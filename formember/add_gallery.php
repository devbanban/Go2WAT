...
if (isset($_SESSION['MM_Username'])) {
  $colname_show_gall = $_SESSION['MM_Username'];
}
mysql_select_db($database_connection, $connection);
$query_show_gall = sprintf("SELECT * FROM tb_gallery WHERE Addby = %s ORDER BY id_gall DESC", GetSQLValueString($colname_show_gall, "text"));
...
<div class="container">
  <div class="row">
    ...
    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="40" colspan="8" align="center" bgcolor="#D6D5D6"><h4>บริหารจัดการแกลเลอรี่</h4>
&nbsp;<a href="#add_gall">+ เพิ่มแกลเลอรี่</a><br>
...
<table border="0">
  <tr>
    ...
    <td><?php if ($pageNum_show_gall < $totalPages_show_gall) { // Show if not last page ?>
      ...
      <?php do { ?>
        <tr>
          <td><img src="../admin/gallery/<?php echo $row_show_gall['Img_index']; ?>" width="100"></td>
          <td align="left" valign="top"><?php echo $row_show_gall['Title']; ?>วัด<?php echo $row_show_gall['Location']; ?>&nbsp; <strong><a href="add_gallery_img.php?id_gall=<?php echo $row_show_gall['id_gall']; ?>"><br>
          +&nbsp;เพิ่มภาพ</a></strong></td>
          <td align="center" valign="top"><br>
          <?php echo $row_show_gall['DateAdd']; ?></td>
          <td align="center" valign="top"><br>
          <?php echo $row_show_gall['status']; ?></td>
          
          <td width="5%" align="center" valign="top"><br>&nbsp;
          <a href="edit_gallery.php?id_gall=<?php echo $row_show_gall['id_gall']; ?>">  <span class="glyphicon glyphicon-pencil"></span> </a></td>
          <td width="5%" align="center" valign="top">
          <br>
              <strong>
              <a href="del_gallery.php?id_gall=<?php echo $row_show_gall['id_gall']; ?>" 
