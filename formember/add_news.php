...
$colname_listnews = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_listnews = $_SESSION['MM_Username'];
}
mysql_select_db($database_connection, $connection);
$query_listnews = sprintf("SELECT * FROM tb_news WHERE Addby = %s ORDER BY News_id DESC", GetSQLValueString($colname_listnews, "text"));
...
$(function() {
  ...
  <table border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="40" colspan="9" align="center" bgcolor="#D6D6D6"><strong>จัดการข่าวสาร</strong>&nbsp;&nbsp;  <strong><a href="#add_news">+ข่าว</a></strong><br>
...
<table border="0">
  <tr>
    ...
    <tr>
      ...
      <td height="40" align="center" bgcolor="#D6D6D6"><strong>status</strong></td>
...
<br>
 ...
 <form method="POST" action="add_news_db.php" enctype="multipart/form-data" name="add_news" id="add_news">
   ...
   <table width="80%" border="0" align="center" cellpadding="3" cellspacing="3">
     ...
     <tr>
       <td align="right" bgcolor="#f1f1f1">หัวข้อข่าว&nbsp; </td>
       <td bgcolor="#f1f1f1"><label for="Title"></label>
